...
Prepared shipments are not lost when the dialog closes. Open **Shipping Workspace** from the Sales Orders header, select one or more saved shipments, and choose **Open selected** to continue pricing submission, label polling, printing, dispatch, or a pending channel retry.
