...
15. Manifest history lists the included channel or Solvantis order references. Choose **Print labels** to retrieve one combined label PDF for the manifest, or choose **Print manifest** to print and sign the Australia Post Order Summary. Both can be printed again from manifest history.
