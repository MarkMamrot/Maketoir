...
Close the shipping dialog at any time and use **Shipping Workspace** in Sales Orders to reopen saved work. Once labelled parcels physically leave, **Mark dispatched** applies the parcel quantities to Sales Order fulfillment and sends tracking to the connected channel. Channel retries do not repeat stock movement or postage.
