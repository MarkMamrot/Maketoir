...
Use Team Communications for operational messages between the active POS location, other available branches, and Warehouse.
...
- [ ] Confirm the POS header shows the location you are speaking from.
- [ ] Choose the intended shared or direct conversation.
- [ ] Remove sensitive or unrelated information from screenshots.
- [ ] Keep each attachment at or below 10 MB.

> **Note:** Team Communications is for staff messages. It does not replace the structured acknowledgements, tasks, requests, needs, and incidents recorded in Store Daybook.
...
5. If evidence helps, paste or choose up to three JPG, PNG, or WebP images, each no larger than 10 MB.
6. Review the message and attachments, then send.
7. Confirm the message appears in the conversation before closing Team Communications.
8. Use **Help** for maintained procedures or **Ask Solvantis** for a product question.
