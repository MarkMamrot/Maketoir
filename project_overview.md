...
- Return reports are physical/customer-return evidence, while Finances v2024-06-19 transactions are settlement evidence. Neither source alone changes stock or customer value, and seller-account net transaction totals must not be used as customer credit-note values.
