...
CREATE TABLE IF NOT EXISTS ims_products (
  ...
  customs_description   VARCHAR(250),
  hs_code               VARCHAR(14),
  country_of_origin     CHAR(2),
  is_dangerous_or_restricted TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ims_shipping_shipments (
  ...
  export_purpose           VARCHAR(20) NULL,
...
CREATE TABLE IF NOT EXISTS ims_credit_notes (
  ...
  shopify_refund_id   VARCHAR(64)  NULL,
...
CREATE TABLE IF NOT EXISTS pos_daybook_task_templates (
  ...
  created_by_name VARCHAR(255) NULL,
  created_by_staff_identity_id BIGINT NULL,
  created_by_staff_name VARCHAR(120) NULL,
  created_by_staff_initials VARCHAR(8) NULL,
  created_at      DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at      DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS pos_daybook_communications (
  ...
  author_staff_identity_id BIGINT NULL,
  author_staff_name VARCHAR(120) NULL,
  author_staff_initials VARCHAR(8) NULL,
