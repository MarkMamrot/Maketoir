...
const tableNames = ['ai_plans', 'business_ai_accounts', 'ai_provider_rates', 'ai_plan_rates', 'ai_usage_calls', 'ai_account_ledger'];

const definitions = {
  ai_plans: `CREATE TABLE ai_plans (plan_key VARCHAR(32) PRIMARY KEY, display_name VARCHAR(100) NOT NULL, description VARCHAR(500) NULL, is_internal TINYINT(1) NOT NULL DEFAULT 0, is_active TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
  ...
  ai_provider_rates: `CREATE TABLE ai_provider_rates (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, provider VARCHAR(32) NOT NULL DEFAULT 'google', model_id VARCHAR(150) NOT NULL, metric ENUM('input_tokens','cached_input_tokens','output_tokens','thinking_tokens','output_image','video_second') NOT NULL, price_per_unit_micros BIGINT UNSIGNED NOT NULL, unit_scale INT UNSIGNED NOT NULL DEFAULT 1000000, source_currency CHAR(3) NOT NULL DEFAULT 'USD', source_price_decimal DECIMAL(20,8) NOT NULL, aud_fx_rate DECIMAL(20,8) NOT NULL, effective_from DATETIME(3) NOT NULL, effective_to DATETIME(3) NULL, created_by INT NULL, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), UNIQUE KEY uq_ai_provider_rate (provider, model_id, metric, effective_from), INDEX idx_ai_provider_rate_lookup (provider, model_id, metric, effective_from, effective_to)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
  ai_plan_rates: `CREATE TABLE ai_plan_rates (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, plan_key VARCHAR(32) NOT NULL, model_id VARCHAR(150) NOT NULL, metric ENUM('input_tokens','cached_input_tokens','output_tokens','thinking_tokens','output_image','video_second') NOT NULL, price_per_unit_micros BIGINT UNSIGNED NOT NULL, unit_scale INT UNSIGNED NOT NULL DEFAULT 1000000, effective_from DATETIME(3) NOT NULL, effective_to DATETIME(3) NULL, created_by INT NULL, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3), UNIQUE KEY uq_ai_plan_rate (plan_key, model_id, metric, effective_from), INDEX idx_ai_plan_rate_lookup (plan_key, model_id, metric, effective_from, effective_to)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
