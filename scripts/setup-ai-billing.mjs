...
const tableNames = ['ai_plans', 'business_ai_accounts', 'ai_provider_rates', 'ai_plan_rates', 'ai_provider_models', 'ai_discovered_models', 'ai_billing_family_mappings', 'ai_billing_mapping_audit', 'ai_provider_sku_observations', 'ai_usage_calls', 'ai_account_ledger'];
