...
const tableNames = [
  ...
  'foresight_meta_experiment_launch_package_confirmations',
  'foresight_campaign_experiment_executions',
  ...
  'foresight_creative_brief_versions',
  'foresight_creative_brief_review_events',
