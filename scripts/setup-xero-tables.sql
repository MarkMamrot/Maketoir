...
CREATE TABLE IF NOT EXISTS xero_reconciliation_settings (
  ...
  digest_frequency  VARCHAR(10)  NOT NULL DEFAULT 'off' COMMENT 'off | daily | weekly',
  digest_timezone   VARCHAR(100) NOT NULL DEFAULT 'Australia/Sydney',
  digest_hour       TINYINT      NOT NULL DEFAULT 8,
  digest_weekly_day TINYINT      NOT NULL DEFAULT 1 COMMENT '0 Sunday through 6 Saturday',
  last_digest_completed_at DATETIME DEFAULT NULL,
  next_target_id    BIGINT       NOT NULL DEFAULT 0,
  scan_limit        INT          NOT NULL DEFAULT 100,
  bootstrap_po_id   BIGINT       NOT NULL DEFAULT 0,
  bootstrap_so_id   BIGINT       NOT NULL DEFAULT 0,
  bootstrap_cn_id   BIGINT       NOT NULL DEFAULT 0,
  bootstrap_scn_id  BIGINT       NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS xero_pos_cash_eod_actions (
  ...
  business_id               VARCHAR(255) NOT NULL,
  eod_reconciliation_id     BIGINT       NOT NULL,
  accounting_version        INT          NOT NULL DEFAULT 3,
  ...
  petty_cash_amount         DECIMAL(14,2) NOT NULL DEFAULT 0,
  ...
  petty_cash_status         VARCHAR(30)  NOT NULL DEFAULT 'not_required',
  ...
  petty_cash_idempotency_key VARCHAR(64) DEFAULT NULL,
  ...
  xero_petty_cash_id        VARCHAR(100) DEFAULT NULL,
  error_detail              TEXT         DEFAULT NULL,
  attempt_count             INT          NOT NULL DEFAULT 0,
  last_attempt_at           DATETIME     DEFAULT NULL,
  completed_at              DATETIME     DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS xero_cash_deposits (
  ...
  destination_account_id      VARCHAR(100) DEFAULT NULL,
  destination_account_code    VARCHAR(50)  DEFAULT NULL,
  ...
  deposited_total             DECIMAL(14,2) DEFAULT NULL,
  bank_variance_total         DECIMAL(14,2) DEFAULT NULL,
