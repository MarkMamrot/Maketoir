...
const COLUMNS = [
  ...
  ['pos_daybook_communications', 'author_staff_identity_id', 'BIGINT NULL AFTER author_name'],
  ['pos_daybook_communications', 'author_staff_name', 'VARCHAR(120) NULL AFTER author_staff_identity_id'],
  ['pos_daybook_communications', 'author_staff_initials', 'VARCHAR(8) NULL AFTER author_staff_name'],
  ['pos_daybook_communications', 'background_color', 'VARCHAR(32) NULL AFTER author_staff_initials'],
  ['pos_daybook_records', 'background_color', 'VARCHAR(32) NULL AFTER actor_name'],
  ['pos_daybook_references', 'background_color', 'VARCHAR(32) NULL AFTER is_active'],
  ['pos_daybook_references', 'secret_label', 'VARCHAR(120) NULL AFTER link_url'],
  ['pos_daybook_references', 'secret_value_encrypted', 'TEXT NULL AFTER secret_label'],
  ['pos_daybook_references', 'author_user_id', 'INT NULL AFTER background_color'],
  ['pos_daybook_references', 'author_name', 'VARCHAR(255) NULL AFTER author_user_id'],
  ['pos_daybook_references', 'author_staff_identity_id', 'BIGINT NULL AFTER author_name'],
  ['pos_daybook_references', 'author_staff_name', 'VARCHAR(120) NULL AFTER author_staff_identity_id'],
  ['pos_daybook_references', 'author_staff_initials', 'VARCHAR(8) NULL AFTER author_staff_name'],
  ['pos_daybook_product_guides', 'background_color', 'VARCHAR(32) NULL AFTER status'],
  ['pos_daybook_product_guides', 'author_user_id', 'INT NULL AFTER background_color'],
  ['pos_daybook_product_guides', 'author_name', 'VARCHAR(255) NULL AFTER author_user_id'],
  ['pos_daybook_product_guides', 'author_staff_identity_id', 'BIGINT NULL AFTER author_name'],
  ['pos_daybook_product_guides', 'author_staff_name', 'VARCHAR(120) NULL AFTER author_staff_identity_id'],
  ['pos_daybook_product_guides', 'author_staff_initials', 'VARCHAR(8) NULL AFTER author_staff_name'],
