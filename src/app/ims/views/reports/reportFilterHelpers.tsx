...
export const EMPTY_MULTI: MultiFilter = { product: null, supplier: null, brand: null, type_: null, category: null, subcategory: null };
...
export function hasMultiFilter(f: MultiFilter) { return !!(f.product || f.supplier || f.brand || f.type_); }
