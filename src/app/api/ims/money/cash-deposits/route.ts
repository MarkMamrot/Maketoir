...
export async function GET() {
  ...
  const deposits = await query<any>(
    `SELECT d.id, d.ims_location_id, d.lodgement_date, d.bank_reference, d.source_account_name,
            ...
            d.accounting_method, d.notes, d.status, d.prepared_by_name, d.posted_by_name, d.posted_at, d.error_detail, d.created_at,
            d.xero_bank_transfer_id, d.xero_bank_transaction_id,
