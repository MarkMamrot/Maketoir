...
export const BULK_PRODUCT_FIELDS: BulkProductFieldDefinition[] = [
  ...
  { id: 'hs_code', label: 'HS Code', owner: 'product', editor: 'text', width: 140, fillDown: true },
  { id: 'country_of_origin', label: 'Country of Origin', owner: 'product', editor: 'select', width: 210, fillDown: true },
  { id: 'is_dangerous_or_restricted', label: 'Dangerous / Restricted', owner: 'product', editor: 'boolean', width: 155, fillDown: true },
