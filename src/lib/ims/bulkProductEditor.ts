...
export const BULK_PRODUCT_FIELDS: BulkProductFieldDefinition[] = [
  ...
  { id: 'price_rrp', label: 'RRP $', owner: 'variant', editor: 'number', width: 105, defaultVisible: true, fillDown: true },
  ...
  { id: 'cost_aud', label: 'Cost $', owner: 'variant', editor: 'number', width: 105, defaultVisible: true, fillDown: true },
