...
export const IMS_SCHEMA_REQUIRED_COLUMNS = {
  ...
  ims_sales_orders: ['replacement_of_so_id', 'wholesale_company_id', 'wholesale_location_id', 'wholesale_member_id', 'is_staff_preview_test', 'staff_preview_session_id', 'staff_preview_actor_user_id', 'staff_preview_actor_name'],
...
export const IMS_SCHEMA_REQUIRED_INDEXES = {
  ...
  ims_sales_orders: ['uq_so_replacement_source', 'idx_so_wholesale_account', 'idx_so_staff_preview'],
