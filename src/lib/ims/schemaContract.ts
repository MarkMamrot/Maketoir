...
export const IMS_SCHEMA_REQUIRED_COLUMNS = {
  ...
  wholesale_draft_orders: ['wholesale_company_id', 'wholesale_location_id', 'wholesale_member_id'],
  wholesale_draft_order_items: ['is_indent', 'indent_qty'],
  ims_purchase_orders: ['replacement_of_po_id'],
  ims_sales_orders: ['replacement_of_so_id', 'wholesale_company_id', 'wholesale_location_id', 'wholesale_member_id'],
...
export const IMS_SCHEMA_REQUIRED_INDEXES = {
  ...
  ims_sales_orders: ['uq_so_replacement_source', 'idx_so_wholesale_account'],
  wholesale_draft_orders: ['idx_wholesale_draft_account'],
