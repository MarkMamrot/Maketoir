export const IMS_SCHEMA_REQUIRED_TABLES = [
  ...
  'ims_shipping_carrier_accounts',
  'ims_shipping_package_presets',
  'ims_shipping_manifests',
  'ims_shipping_shipments',
  'ims_shipping_parcels',
  'ims_shipping_parcel_items',
  'ims_shipping_labels',
  'ims_shipping_channel_jobs',
...
export const IMS_SCHEMA_REQUIRED_COLUMNS = {
  ...
  pos_daybook_reference_categories: ['business_id', 'location_id', 'name', 'is_active', 'created_at', 'updated_at'],
  ...
  ims_channel_product_selections: ['business_id', 'channel_instance_id', 'product_id', 'desired_enabled', 'observed_enabled', 'publication_status', 'safe_error'],
  ims_channel_product_mappings: ['business_id', 'channel_instance_id', 'product_id', 'external_product_id', 'external_parent_id', 'external_status', 'metadata_json'],
  ims_channel_variant_mappings: ['business_id', 'channel_instance_id', 'variant_id', 'external_variant_id', 'external_inventory_item_id', 'external_sku', 'external_asin', 'metadata_json'],
  ims_channel_customer_mappings: ['business_id', 'channel_instance_id', 'contact_id', 'external_customer_id'],
  ims_channel_events: ['business_id', 'channel_instance_id', 'provider_event_id', 'event_type', 'payload_hash', 'encrypted_payload', 'status', 'attempts', 'available_at', 'processed_at', 'safe_error'],
  ims_channel_sync_jobs: ['business_id', 'channel_instance_id', 'operation', 'resource_type', 'resource_id', 'idempotency_key', 'payload_json', 'status', 'attempts', 'available_at', 'lease_token', 'lease_expires_at', 'completed_at', 'safe_error'],
  ims_shipping_carrier_accounts: ['base_url'],
  ims_stock: ['zone', 'bin'],
...
export const IMS_SCHEMA_REQUIRED_INDEXES = {
  ...
  ims_channel_product_selections: ['uq_channel_product_selection', 'idx_channel_product_selection_status', 'idx_channel_product_selection_product'],
  ims_channel_product_mappings: ['uq_channel_product_mapping', 'uq_channel_external_product', 'idx_channel_product_mapping_product'],
  ims_channel_variant_mappings: ['uq_channel_variant_mapping', 'uq_channel_external_variant', 'idx_channel_variant_mapping_variant', 'idx_channel_variant_mapping_sku'],
  ims_channel_customer_mappings: ['uq_channel_customer_mapping', 'uq_channel_external_customer', 'idx_channel_customer_mapping_contact'],
