...
export const IMS_SCHEMA_REQUIRED_COLUMNS = {
  ...
  ims_so_shipments: ['business_id', 'channel_instance_id', 'so_id', 'shopify_fulfilment_id'],
  ims_credit_notes: ['business_id', 'source', 'settlement_method', 'channel_instance_id', 'external_return_id', 'external_refund_id'],
  gift_cards: ['channel_instance_id', 'shopify_gc_id', 'code', 'status'],
  ...
  ims_stock: ['zone', 'bin'],
  ims_inventory_cost_state: ['business_id', 'active_method', 'active_epoch_id', 'revision'],
  ims_inventory_cost_epochs: ['business_id', 'method', 'status', 'operation_key', 'request_hash'],
  ims_fifo_cost_layers: [
    'business_id',
    'epoch_id',
    'variant_id',
  ...
  ims_sales_orders: ['replacement_of_so_id', 'wholesale_company_id', 'wholesale_location_id', 'wholesale_member_id', 'is_staff_preview_test', 'staff_preview_session_id', 'staff_preview_actor_user_id', 'staff_preview_actor_name', 'sales_channel', 'channel_instance_id', 'external_order_id', 'native_checkout_id', 'gift_card_amount', 'channel_shipping_method', 'channel_delivery_type'],
  ...
  ims_stock_movements: ['source_line_id', 'cost_method_snapshot', 'cost_epoch_id'],
  ims_stocktakes: [
    'reverted_at',
    'reversal_reason',
    'reversed_by',
...
export const IMS_SCHEMA_REQUIRED_INDEXES = {
  ...
  ims_inventory_cost_state: ['uq_inventory_cost_state_business'],
  ims_inventory_cost_epochs: ['uq_inventory_cost_epoch_operation', 'idx_inventory_cost_epoch_active'],
  ims_fifo_cost_layers: ['idx_fifo_layer_consume', 'idx_fifo_layer_source', 'idx_fifo_layer_parent'],
  ims_fifo_cost_allocations: [
    'uq_fifo_allocation_movement_layer',
    'idx_fifo_allocation_layer',
    'idx_fifo_allocation_movement',
  ],
  ...
  ims_so_shipments: ['uq_so_shipment_shopify_instance'],
  ims_credit_notes: ['uq_business_cn', 'uq_cn_channel_return', 'uq_cn_channel_refund', 'idx_cn_shopify_refund'],
  gift_cards: ['uq_gc_instance_code', 'uq_gc_shopify_instance', 'idx_gc_reconciliation'],
