...
export const IMS_SCHEMA_REQUIRED_COLUMNS = {
  ...
  ims_stock: ['zone', 'bin'],
  ims_inventory_cost_state: ['business_id', 'active_method', 'active_epoch_id', 'revision', 'last_switched_at'],
  ims_inventory_cost_epochs: ['business_id', 'method', 'status', 'operation_key', 'request_hash', 'opening_quantity', 'opening_value'],
  ims_fifo_cost_layers: ['business_id', 'epoch_id', 'variant_id', 'location_id', 'source_type', 'fifo_date', 'original_quantity', 'remaining_quantity', 'unit_cost'],
  ims_fifo_cost_allocations: ['business_id', 'epoch_id', 'stock_movement_id', 'layer_id', 'quantity', 'unit_cost', 'allocated_value', 'allocation_type'],
  ...
  ims_stock_movements: ['cost_method_snapshot', 'cost_epoch_id'],
...
export const IMS_SCHEMA_REQUIRED_INDEXES = {
  ...
  ims_fifo_cost_allocations: ['uq_fifo_allocation_movement_layer', 'idx_fifo_allocation_layer', 'idx_fifo_allocation_movement'],
  ims_stock_movements: ['idx_sm_cost_epoch'],
