...
export type ForesightPromptId = 'strategy-interviewer' | 'initiative-planner' | 'planner-dialogue' | 'campaign-deliverables' | 'campaign-learning' | 'campaign-experiment' | 'creative-assessment' | 'creative-brief';
...
const PROMPTS: Record<ForesightPromptId, { version: string; filename: string }> = {
  ...
  'creative-brief': { version: 'creative-brief-v1', filename: 'creative-brief-v1.md' },
};
